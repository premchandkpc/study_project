...
Tag: `Database`
Doc path: `docs/system-design/sd-db-sharding.md`
...
1. How would you shard a users table for a social network with 500M users?
   1. **Shard key choice:** `user_id` (UUID/Snowflake). Avoid sharding by name/email - skewed distributions. Avoid by geography unless you need data residency.
