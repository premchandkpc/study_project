...
- Area: Databases
- Tag: MongoDB
- Source: `src/modules/topics/databases/db-mongodb-internals.js`
- Tags: `mongodb`, `wiredtiger`, `bson`, `aggregation`, `indexes`
- Visual coverage: live visual

## Concept

This topic covers mongodb internals. It explains the concept, why it matters, and how it fits into production systems.
## Why It Matters
