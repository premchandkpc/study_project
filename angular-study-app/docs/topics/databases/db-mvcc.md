...
- Area: Databases
- Tag: Transactions
- Source: `src/modules/topics/databases/db-mvcc.js`
- Tags: `database`, `mvcc`, `snapshot`, `versions`, `vacuum`
- Visual coverage: live visual

## Concept

This topic covers mvcc & snapshot isolation. It explains the concept, why it matters, and how it fits into production systems.
## Why It Matters
