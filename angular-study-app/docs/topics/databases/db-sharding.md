...
- Area: Databases
- Tag: Scalability
- Source: `src/modules/topics/databases/db-sharding.js`
- Tags: `database`, `sharding`, `range`, `hash`, `consistent-hash`, `hotspot`
- Visual coverage: live visual

## Concept

This topic covers database sharding. It explains the concept, why it matters, and how it fits into production systems.
## Why It Matters
