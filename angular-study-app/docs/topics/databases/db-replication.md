...
- Area: Databases
- Tag: Reliability
- Source: `src/modules/topics/databases/db-replication.js`
- Tags: `database`, `replication`, `wal-shipping`, `logical`, `lag`
- Visual coverage: live visual

## Concept

This topic covers database replication. It explains the concept, why it matters, and how it fits into production systems.
## Why It Matters
