...
- Area: Databases
- Tag: Internals
- Source: `src/modules/topics/databases/db-btree-lsm.js`
- Tags: `database`, `btree`, `lsm`, `storage`, `indexes`
- Visual coverage: live visual

## Concept

This topic covers b tree vs lsm tree. It explains the concept, why it matters, and how it fits into production systems.
## Why It Matters
