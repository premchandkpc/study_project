...
- Area: Databases
- Tag: Performance
- Source: `src/modules/topics/databases/db-connection-pooling.js`
- Tags: `database`, `pgbouncer`, `pool-sizing`, `connections`
- Visual coverage: live visual

## Concept

Connection pooling reuses open database connections across requests. This reduces connection setup overhead and keeps active DB sessions within configured limits.
## Why It Matters
