...
- Area: Databases
- Tag: Performance
- Source: `src/modules/topics/databases/db-indexes.js`
- Tags: `database`, `indexes`, `btree`, `hash`, `covering`, `partial`
- Visual coverage: live visual

## Concept

This topic covers index internals. It explains the concept, why it matters, and how it fits into production systems.
## Why It Matters
