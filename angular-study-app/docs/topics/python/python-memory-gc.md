...
1. What is the difference between del and garbage collection in Python?
   ...
   Follow-ups: What is **del** and why is it dangerous?; How does generational GC work?
...
2. How do you find memory leaks in a long-running Python service?
   ...
   Follow-ups: What is a reference cycle involving **del**?; How does weakref.WeakValueDictionary help caches?
...
- **slots** is a low-effort 50-70% memory saving for many small objects.
